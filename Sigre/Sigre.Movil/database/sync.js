...
/**
 * OBSOLETO:
 * La descarga offline actual se hace con /Feeder/export
 * y no con inserciones manuales de deficiencias.
 * Se deja este stub solo para no romper imports viejos.
 */
export const syncDeficiencies = async () => {
  console.warn("syncDeficiencies está obsoleto. Usa downloadDatabase()/Feeder/export.");
  return [];
};