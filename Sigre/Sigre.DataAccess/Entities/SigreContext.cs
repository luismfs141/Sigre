...
public partial class SigreContext : DbContext
{
    ...
    public virtual DbSet<Bdtercero> Bdterceros { get; set; }
    ...
    public virtual DbSet<NuevasDef> NuevasDefs { get; set; }

    public virtual DbSet<NuevosArch> NuevosArches { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=localhost;Initial Catalog=sigre;Persist Security Info=False;User ID=sa;Password=1342;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=True;Connection Timeout=30;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Bdtercero>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("BDTERCEROS");
            ...
            entity.Property(e => e.C10).HasMaxLength(255);
            ...
            entity.Property(e => e.C8).HasMaxLength(255);
            entity.Property(e => e.C9).HasMaxLength(255);
        });
        ...
        modelBuilder.Entity<NuevasDef>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("nuevasDef");

            entity.Property(e => e.DefiActivo).HasColumnName("defiActivo");
            entity.Property(e => e.DefiArmadoMaterial)
                .HasMaxLength(2)
                .IsUnicode(false)
                .HasColumnName("defiArmadoMaterial");
            entity.Property(e => e.DefiCodAmt)
                .HasMaxLength(5)
                .IsUnicode(false)
                .HasColumnName("defiCodAMT");
            entity.Property(e => e.DefiCodDef)
                .HasMaxLength(20)
                .IsUnicode(false)
                .HasColumnName("defiCodDef");
            entity.Property(e => e.DefiCodDen).HasColumnName("defiCodDen");
            entity.Property(e => e.DefiCodRes).HasColumnName("defiCodRes");
            entity.Property(e => e.DefiCodigoElemento)
                .HasMaxLength(50)
                .IsUnicode(false)
                .HasColumnName("defiCodigoElemento");
            entity.Property(e => e.DefiComentario)
                .HasMaxLength(120)
                .IsUnicode(false)
                .HasColumnName("defiComentario");
            entity.Property(e => e.DefiCoordX).HasColumnName("defiCoordX");
            entity.Property(e => e.DefiCoordY).HasColumnName("defiCoordY");
            entity.Property(e => e.DefiDistHorizontal)
                .HasColumnType("numeric(10, 2)")
                .HasColumnName("defiDistHorizontal");
            entity.Property(e => e.DefiDistTransversal)
                .HasColumnType("numeric(10, 2)")
                .HasColumnName("defiDistTransversal");
            entity.Property(e => e.DefiDistVertical)
                .HasColumnType("numeric(10, 2)")
                .HasColumnName("defiDistVertical");
            entity.Property(e => e.DefiEstado)
                .HasMaxLength(1)
                .IsUnicode(false)
                .IsFixedLength()
                .HasColumnName("defiEstado");
            entity.Property(e => e.DefiEstadoCriticidad).HasColumnName("defiEstadoCriticidad");
            entity.Property(e => e.DefiEstadoSubsanacion)
                .HasMaxLength(1)
                .IsUnicode(false)
                .IsFixedLength()
                .HasColumnName("defiEstadoSubsanacion");
            entity.Property(e => e.DefiFecModificacion)
                .HasColumnType("datetime")
                .HasColumnName("defiFecModificacion");
            entity.Property(e => e.DefiFecRegistro)
                .HasColumnType("datetime")
                .HasColumnName("defiFecRegistro");
            entity.Property(e => e.DefiFechaCreacion)
                .HasColumnType("datetime")
                .HasColumnName("defiFechaCreacion");
            entity.Property(e => e.DefiFechaDenuncia)
                .HasColumnType("datetime")
                .HasColumnName("defiFechaDenuncia");
            entity.Property(e => e.DefiFechaInspeccion)
                .HasColumnType("datetime")
                .HasColumnName("defiFechaInspeccion");
            entity.Property(e => e.DefiFechaSubsanacion)
                .HasColumnType("datetime")
                .HasColumnName("defiFechaSubsanacion");
            entity.Property(e => e.DefiIdElemento).HasColumnName("defiIdElemento");
            entity.Property(e => e.DefiInterno).HasColumnName("defiInterno");
            entity.Property(e => e.DefiLatitud).HasColumnName("defiLatitud");
            entity.Property(e => e.DefiLongitud).HasColumnName("defiLongitud");
            entity.Property(e => e.DefiNodoFinal)
                .HasMaxLength(20)
                .IsUnicode(false)
                .HasColumnName("defiNodoFinal");
            entity.Property(e => e.DefiNodoInicial)
                .HasMaxLength(20)
                .IsUnicode(false)
                .HasColumnName("defiNodoInicial");
            entity.Property(e => e.DefiNroOrden)
                .HasMaxLength(50)
                .IsUnicode(false)
                .HasColumnName("defiNroOrden");
            entity.Property(e => e.DefiNumPostes).HasColumnName("defiNumPostes");
            entity.Property(e => e.DefiNumSuministro)
                .HasMaxLength(20)
                .IsUnicode(false)
                .HasColumnName("defiNumSuministro");
            entity.Property(e => e.DefiObservacion)
                .IsUnicode(false)
                .HasColumnName("defiObservacion");
            entity.Property(e => e.DefiPointX).HasColumnName("defiPointX");
            entity.Property(e => e.DefiPointY).HasColumnName("defiPointY");
            entity.Property(e => e.DefiPozoTierra)
                .HasMaxLength(20)
                .IsUnicode(false)
                .HasColumnName("defiPozoTierra");
            entity.Property(e => e.DefiPozoTierra2)
                .HasMaxLength(20)
                .IsUnicode(false)
                .HasColumnName("defiPozoTierra2");
            entity.Property(e => e.DefiRefer1)
                .HasMaxLength(30)
                .IsUnicode(false)
                .HasColumnName("defiRefer1");
            entity.Property(e => e.DefiRefer2)
                .HasMaxLength(30)
                .IsUnicode(false)
                .HasColumnName("defiRefer2");
            entity.Property(e => e.DefiResponsable).HasColumnName("defiResponsable");
            entity.Property(e => e.DefiRetenidaMaterial)
                .HasMaxLength(2)
                .IsUnicode(false)
                .HasColumnName("defiRetenidaMaterial");
            entity.Property(e => e.DefiTipoArmado)
                .HasMaxLength(20)
                .IsUnicode(false)
                .HasColumnName("defiTipoArmado");
            entity.Property(e => e.DefiTipoElemento)
                .HasMaxLength(4)
                .IsUnicode(false)
                .IsFixedLength()
                .HasColumnName("defiTipoElemento");
            entity.Property(e => e.DefiTipoMaterial)
                .HasMaxLength(3)
                .IsUnicode(false)
                .HasColumnName("defiTipoMaterial");
            entity.Property(e => e.DefiTipoRetenida)
                .HasMaxLength(2)
                .IsUnicode(false)
                .HasColumnName("defiTipoRetenida");
            entity.Property(e => e.DefiUsuCre)
                .HasMaxLength(50)
                .IsUnicode(false)
                .HasColumnName("defiUsuCre");
            entity.Property(e => e.DefiUsuNpc)
                .HasMaxLength(50)
                .IsUnicode(false)
                .HasColumnName("defiUsuNPC");
            entity.Property(e => e.DefiUsuarioInic)
                .HasMaxLength(30)
                .IsUnicode(false)
                .HasColumnName("defiUsuarioInic");
            entity.Property(e => e.DefiUsuarioMod)
                .HasMaxLength(30)
                .IsUnicode(false)
                .HasColumnName("defiUsuarioMod");
            entity.Property(e => e.InspInterno).HasColumnName("inspInterno");
            entity.Property(e => e.TablInterno).HasColumnName("tablInterno");
            entity.Property(e => e.TipiInterno).HasColumnName("tipiInterno");
        });

        modelBuilder.Entity<NuevosArch>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("nuevosArch");

            entity.Property(e => e.ArchActivo).HasColumnName("archActivo");
            entity.Property(e => e.ArchCodTabla).HasColumnName("archCodTabla");
            entity.Property(e => e.ArchInterno).HasColumnName("archInterno");
            entity.Property(e => e.ArchNombre)
                .HasMaxLength(255)
                .HasColumnName("archNombre");
            entity.Property(e => e.ArchTabla)
                .HasMaxLength(255)
                .HasColumnName("archTabla");
            entity.Property(e => e.ArchTipo).HasColumnName("archTipo");
        });

        modelBuilder.Entity<Ordene>(entity =>
        {
            entity.HasKey(e => e.OrdeInterno).HasName("PK__Ordenes__DD34E2BC79E659B2");
