...
export default function MapaPrincipalWeb() {
  ...
  const { fetchGapsBySed, loading: lGaps } = useGap();
  ...
  const searchSedsLocal = (event) => {
    ...
    const filtered = listaSeds.filter(
      (s) =>
  ...
  const handleVisualize = async () => {
    ...
    if (!selectedSed) {
      console.error(
        "❌ selectedSed es NULL. El botón no debería estar activo.",
      );
    ...
    if (typeof setTotalPins !== "function") {
      ...
      alert(
        "ERROR DE CÓDIGO: Faltó agregar 'setTotalPins' en DatosContext.jsx. La app va a fallar.",
      );
    }
    ...
    try {
      ...
      if (safePins.length > 0) {
        ...
        toast.current.show({
          severity: "info",
          summary: "Vacío",
          detail: "La SED existe pero no tiene coordenadas.",
        });
      }
    } catch (e) {
  ...
  return (
    <div className="relative w-full h-screen flex flex-column bg-gray-100 overflow-hidden">
      ...
      {/* PANEL FLOTANTE */}
      <div
        className="absolute top-0 left-0 m-3 shadow-6 border-round-lg surface-card"
        style={{
          zIndex: 5000,
          width: "320px",
        ...
        >
              ...
              >
                ...
                <Popup>
                  <div className="flex flex-column gap-1">
                    ...
                    <span
                      className={`text-xs font-bold ${isGapCompletado ? "text-green-600" : "text-blue-600"}`}
                    >
          ...
          {pins.map((pin, i) => {
            ...
            const estaInspeccionado =
              pin.inspeccionado === true || pin.Inspeccionado === true;
              ...
              >
                ...
                <Popup>
                  <div className="flex flex-column gap-1">
                    ...
                    <span
                      className={`text-xs font-bold ${estaInspeccionado ? "text-green-600" : "text-blue-600"}`}
                    >
