...
/************ POSTES **********/
/******************************/
select		a.ALIM_Codigo FeederCode, p.POST_Interno ElementId, 'POST' ElementType, p.POST_CodigoNodo CodIns, p.POST_Etiqueta Label, 
			d.CODI_Codigo TypificationCode, '' SedType, '' StartNode, '' EndNode, f.Ruta PhotosPath, f.Cantidad PhotosQuantity
from		Postes			p
...
where		a.ALIM_Etiqueta = 'Corpac'
order by	ElementId

/******************************/
/************ VANOS ***********/
/******************************/
select		a.ALIM_Codigo FeederCode, v.VANO_Interno ElementId, 'VANO' ElementType, v.VANO_Codigo CodIns, v.VANO_Etiqueta Label, 
			d.CODI_Codigo TypificationCode, '' SedType, d.DEFI_NodoInicial StartNode, d.DEFI_NodoFinal EndNode, f.Ruta PhotosPath, f.Cantidad PhotosQuantity
from		Vanos			v
...
/************* SEDS ***********/
/******************************/
select		a.ALIM_Codigo FeederCode, s.SED_Interno ElementId, 'SED' ElementType, s.SED_Codigo CodIns, s.SED_Etiqueta Label, 
			d.CODI_Codigo TypificationCode, s.SED_Tipo SedType, '' StartNode, '' EndNode, f.Ruta PhotosPath, f.Cantidad PhotosQuantity
from	    Seds			s
