...
where		a.ALIM_Etiqueta = 'Cerro Colorado' and d.DEFI_Activo =1 and ( d.DEFI_FecRegistro>='2023-05-10' or DEFI_FecModificacion >= '2023-05-10')
order by	d.DEFI_UsuarioMod, p.POST_Interno

/****************************/
/************ SED ***********/
/****************************/

select		a.ALIM_Codigo CodAlimentador, a.ALIM_Etiqueta Alimentador,d.DEFI_TipoElemento, s.SED_Latitud Latitud, s.SED_Longitud Longitud,
...
where		a.ALIM_Etiqueta = 'Cerro Colorado' and d.DEFI_Activo =1 and ( d.DEFI_FecRegistro>= '2023-05-10' or DEFI_FecModificacion >= '2023-05-10')
order by	d.DEFI_UsuarioMod, s.SED_Interno
...
where		a.ALIM_Etiqueta = 'Cerro Colorado' and d.DEFI_Activo =1 and ( d.DEFI_FecRegistro>= '2023-05-10' or DEFI_FecModificacion >= '2023-05-10')
order by	d.DEFI_UsuarioMod, v.VANO_Interno