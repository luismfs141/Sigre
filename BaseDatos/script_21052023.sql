...
as 
begin
select SUBSTRING(ar.ARCH_Nombre,1,CHARINDEX('/',ar.ARCH_Nombre,19)-1) Ruta, d.DEFI_Estado, d.DEFI_TipoElemento, ALIM_Etiqueta,ALIM_Interno
From Archivos ar
...
group by SUBSTRING(ar.ARCH_Nombre,1,CHARINDEX('/',ar.ARCH_Nombre,19)-1), d.DEFI_Estado, d.DEFI_TipoElemento, ALIM_Etiqueta, ALIM_Interno
