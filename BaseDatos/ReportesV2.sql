...
/********* POSTES ***********/
/****************************/
select		a.ALIM_Codigo CodAlimentador, a.ALIM_Etiqueta Alimentador,d.DEFI_TipoElemento, p.POST_CodigoNodo CodigoNodoPoste, p.POST_Etiqueta EtiquetaPoste, 
			...
			isnull(d.DEFI_ArmadoMaterial,'') [Armado Material],d.DEFI_FechaDenuncia FechaDenuncia, d.DEFI_FechaInspeccion FechaInspeccion,
			...
			isnull(d.DEFI_Comentario, '') Comentario, ar.[1] Foto1, ar.[2] Foto2, ar.[3] Foto3, ar.[4] Foto4, ar.[5] Foto5, ar.[6] Foto6, arc.Ruta
from		Postes			p
...
where		a.ALIM_Etiqueta = 'portales'
...
select		a.ALIM_Codigo CodAlimentador, a.ALIM_Etiqueta Alimentador,d.DEFI_TipoElemento, s.SED_Codigo CodigoSed, s.SED_Etiqueta EtiquetaSed, 
			d.DEFI_CodDef CodDeficiencia,
			case d.DEFI_Estado
				when 'S' then 'Seal'
				when 'N' then 'Nueva Deficiencia'
			...
			isnull(d.DEFI_TipoMaterial,'') [Tipo Material],isnull(d.DEFI_TipoRetenida,'') Retenida, isnull(d.DEFI_TipoArmado,'') Armado,
			isnull(d.DEFI_ArmadoMaterial,'') [Armado Material],isnull(d.DEFI_PozoTierra,'') [Pozo Tierra 1],isnull(d.DEFI_PozoTierra2,'') [Pozo Tierra2],
			d.DEFI_FechaDenuncia FechaDenuncia, d.DEFI_FechaInspeccion FechaInspeccion,d.DEFI_FechaSubsanacion FechaSubsanacion, 
